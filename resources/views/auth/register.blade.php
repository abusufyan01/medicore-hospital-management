...
<body class="bg-[#f8fafc] min-h-screen flex items-center justify-center py-10">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-3xl border border-slate-200 shadow-sm p-8">
            ...
            <p class="text-slate-500 text-sm mb-6">Register to access the hospital system</p>
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" required autofocus
                            class="w-full border border-slate-200 rounded-xl pl-11 pr-4 py-3 outline-none focus:ring-4 focus:ring-blue-50 focus:border-blue-500 transition-all @error('name') border-rose-500 @enderror"
